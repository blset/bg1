defmodule Bg1Web.ParameterControllerTest do
  use Bg1Web.ConnCase

  import Bg1.ParametersFixtures

  @create_attrs %{phonelink: "some phonelink", signature: "some signature"}
  ...
  describe "update parameter" do
    ...
    test "redirects when data is valid", %{conn: conn, parameter: parameter} do
      ...
      assert html_response(conn, 200) =~ "some updated phonelink"
    end
